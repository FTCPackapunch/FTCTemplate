 ...
 *  x axis is from the back wheel along the direction perpendicular to the parallel wheels
 *  Y axis is line between the two parallel dead wheels
 *    /--------------\
 *    |     ____     |
 *    |     ----     |
 *    | ||        || |
...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    //these below are the tiks and radius for the dead wheels, since we are using gobilda it is from their site

    public static double TICKS_PER_REV = 2000;
    public static double WHEEL_RADIUS = 0.945; // in
    public static double GEAR_RATIO = 1; // output (wheel) speed / input (encoder) speed

    //measure the distance between the two parallel dead wheels
    public static double LATERAL_DISTANCE = 13.1; // in; distance between the left and right wheels
    //this is the distance from the parallel dead wheel to the back dead wheel
